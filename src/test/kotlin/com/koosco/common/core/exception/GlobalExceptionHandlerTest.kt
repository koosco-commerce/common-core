...
class TestController {
    ...
    fun success(): ApiResponse<Map<String, String>> {
        return ApiResponse.success(mapOf("message" to "Hello"))
    }

    @GetMapping("/not-found")
    fun notFound(): ApiResponse<Nothing> {
        throw NotFoundException(message = "Resource not found")
    }

    @GetMapping("/validation")
    fun validation(): ApiResponse<Nothing> {
    ...
    fun validateBody(@Valid @RequestBody request: TestRequest): ApiResponse<TestRequest> {
        return ApiResponse.success(request)
    }

    @GetMapping("/required-param")
    fun requiredParam(@RequestParam name: String): ApiResponse<String> {
        return ApiResponse.success(name)
    }

    @GetMapping("/type-mismatch")
    fun typeMismatch(@RequestParam id: Int): ApiResponse<Int> {
        return ApiResponse.success(id)
    }

    @GetMapping("/unexpected")
    fun unexpected(): ApiResponse<Nothing> {
